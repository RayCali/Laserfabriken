...
- Koppla in USB-CLI, kör `status`, bekräfta att kortet svarar och att temperaturavläsningarna ser rimliga ut (bekräftar att SPI/ADS1220 fungerar, §6.4 — inga skräpvärden)
