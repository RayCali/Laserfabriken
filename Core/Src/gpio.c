...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DAC_CS_Pin|ADC_CS_Pin, GPIO_PIN_SET);
  ...
  HAL_GPIO_Init(TEC_PG_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : DAC_CS_Pin ADC_CS_Pin */
  GPIO_InitStruct.Pin = DAC_CS_Pin|ADC_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : TEC_EN_Pin POLARITY_Pin */
  ...
  /*Configure GPIO pins : M6_EN_Pin DISPLAY_DO1_Pin DISPLAY_DO2_Pin DISPLAY_DO3_Pin */
